...
import { validateForm as validateFormUtil } from "@/lib/validation";
...
const Index = () => {
  ...
  const validateForm = (): boolean => {
    const newErrors = validateFormUtil(
      formData,
      referenceFiles,
      selectedUsage,
      t,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const loadingToast = toast.loading(lang === "en" ? "Submitting your request..." : "നിങ്ങളുടെ അഭ്യർത്ഥന സമർപ്പിക്കുന്നു...");
